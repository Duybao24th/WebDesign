...
const INITIAL_PRODUCTS = [
    { id: 'P001', name: 'Đèn bàn Gốm Thủ Công', category: 'Đèn', price: 1250000, stock: 15, imageUrl: 'https://picsum.photos/seed/lamp1/400/400', createdAt: new Date().toISOString() },
    { id: 'P002', name: 'Tranh Canvas Trừu Tượng', category: 'Tranh', price: 850000, stock: 8, imageUrl: 'https://picsum.photos/seed/art1/400/400', createdAt: new Date().toISOString() },
    { id: 'P003', name: 'Cây Bàng Singapore Giả', category: 'Cây giả', price: 450000, stock: 20, imageUrl: 'https://picsum.photos/seed/plant1/400/400', createdAt: new Date().toISOString() },
    { id: 'P004', name: 'Tượng Gốm Decor Tối Giản', category: 'Decor bàn', price: 320000, stock: 25, imageUrl: 'https://picsum.photos/seed/decor1/400/400', createdAt: new Date().toISOString() },
    { id: 'P005', name: 'Đèn Thả Trần Mây Tre', category: 'Đèn', price: 980000, stock: 10, imageUrl: 'https://picsum.photos/seed/lamp2/400/400', createdAt: new Date().toISOString() },
    { id: 'P006', name: 'Bộ 3 Lọ Hoa Thủy Tinh', category: 'Decor bàn', price: 550000, stock: 12, imageUrl: 'https://picsum.photos/seed/vase1/400/400', createdAt: new Date().toISOString() },
];
