...
const INITIAL_PRODUCTS = [
    { id: 'P001', name: 'Đèn bàn Gốm Thủ Công', category: 'Đèn', price: 1250000, stock: 15, imageUrl: 'https://www.google.com/imgres?q=%C4%90%C3%A8n%20b%C3%A0n%20G%E1%BB%91m%20Th%E1%BB%A7%20C%C3%B4ng%20%E1%BA%A3nh%20jpg&imgurl=https%3A%2F%2Fflexhouse.vn%2Fwp-content%2Fuploads%2F2022%2F12%2FDen-de-ban-bang-gom-thu-cong-moc-mac-KLS112911.jpg&imgrefurl=https%3A%2F%2Fflexhouse.vn%2Fden-de-ban-bang-gom-thu-cong-moc-mac-kls1129%2F%3Fsrsltid%3DAfmBOoovoduVdQ51N9Y6XRc2wyoIr9BrCDGXi2rLe4iZplJNwKBCuYfQ&docid=DLsDuEnsd9swNM&tbnid=iOg8R1KR77gIhM&vet=12ahUKEwj6nt2AjKSUAxUak1YBHYlkFd0QnPAOegQIGRAB..i&w=750&h=750&hcb=2&ved=2ahUKEwj6nt2AjKSUAxUak1YBHYlkFd0QnPAOegQIGRAB', createdAt: new Date().toISOString() },
    { id: 'P002', name: 'Đèn để bàn phòng khách', category: 'Đèn', price: 1500000, stock: 8, imageUrl: 'https://www.google.com/aclk?sa=L&ai=DChsSEwiV06mwjaSUAxVawEwCHVPuBeIYACICCAEQAxoCdG0&co=1&ase=2&gclid=CjwKCAjwzevPBhBaEiwAplAxviVsRoUPXi3qgGVU3Cavl3w0MoW6JQyRJgNFP9fjq5MMuzjVIgLDFBoCYeQQAvD_BwE&cid=CAASuwHkaNijImSJrqnvYpLrAHrp1QrxI37DuBznjOuYsD625QnG6wxvLGUxCLKQcH9Q1-3Q6TIsS8RHKZqPopa2gQsc6LG5HyDZsGRN2Sq5uJ-ivjmfxHlAyweXgNUut6NvH4TH1NaxiQFsmhkODgee7l_v9nWP20Ns3uJYGCJt6wi8mUroITw70pt9imFUr4GfSx_QFziVZvOzvn2d1UdKqiAsnApk8UE-rEeI60li5_zhZsY2w8C_wx5-fAZV&cce=2&category=acrcp_v1_32&sig=AOD64_3qrFHKe27yOusHzbD0pu4CBwBoWQ&ctype=5&q=&nis=4&ved=2ahUKEwj_xqSwjaSUAxUMsVYBHTWgMvoQ9aACKAB6BAgJEBY&adurl=', createdAt: new Date().toISOString() },
    { id: 'P003', name: 'Tranh Canvas Trừu Tượng', category: 'Tranh', price: 850000, stock: 12, imageUrl: 'https://brocanvas.vn/san-pham/tranh-canvas-truu-tuong-hinh-ngon-nui-mau-nau-decor-nghe-thuat-bro6948/?srsltid=AfmBOoqhK5QN1ZCSMpLOPjagF_jhFT2u4enzyTvEEbgCgkLrHoIC5Xqm', createdAt: new Date().toISOString() },
    { id: 'P004', name: 'Tranh Phong Cảnh', category: 'Tranh', price: 5500000, stock: 20, imageUrl: 'https://vector6.com/tranh-phong-canh-dep-tuyen-tap-chon-loc-moi-file-psd-61/', createdAt: new Date().toISOString() },
    { id: 'P005', name: 'Cây Bàng Singapore Giả', category: 'Cây giả', price: 450000, stock: 20, imageUrl: 'https://ironstyle.vn/cay-bang-singapore-gia-trang-tri-nhieu-nhanh/2502.html', createdAt: new Date().toISOString() },
    { id: 'P006', name: 'Cây Giả Decor', category: 'Cây Giả', price: 320000, stock: 25, imageUrl: 'https://shoptrangtri.vn/cay-gia-decor-khong-gian-xanh?srsltid=AfmBOoojadInHouUTqX0b4Cjh8qGYcUzVZ2sXzDrojvZtPupzRh64VOx', createdAt: new Date().toISOString() },
    { id: 'P007', name: 'Tượng Gốm Decor Tối Giản', category: 'Decor bàn', price: 320000, stock: 25, imageUrl: 'https://www.noithatpassion.com/products/tuong-decor-hinh-xoan-bang-gom-phong-cach-toi-gian?srsltid=AfmBOor4iAfoEGBcbKJKm5m1LaBk3tduIK3Xaj996FpxA9Dv5KPjt2kX', createdAt: new Date().toISOString() },
    { id: 'P008', name: 'Cờ Để Bàn Decor', category: 'Decor bàn', price: 980000, stock: 10, imageUrl: 'https://cuahangco.com/san-pham/co-de-ban-lam-viec-de-inox-loai-cao-cap/?srsltid=AfmBOoouZG1ZnGm62OBJpx-nYjWlW3e52p4XTntY7YzmMGsWAOowDOko', createdAt: new Date().toISOString() },
    { id: 'P009', name: 'Quả Cầu Tuyết Decor', category: 'Decor bàn', price: 550000, stock: 18, imageUrl: 'https://ideashop.vn/qua-cau-tuyet-giang-sinh-ong-gia-noel-xe-tuan-loc-than-tien-p38420076.html', createdAt: new Date().toISOString() },
];
